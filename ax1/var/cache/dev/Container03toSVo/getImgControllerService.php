 ...
 */
class getImgControllerService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'App\Controller\ImgController' shared autowired service.
     *
     * @return \App\Controller\ImgController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'framework-bundle'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'AbstractController.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'ImgController.php';

        $container->services['App\\Controller\\ImgController'] = $instance = new \App\Controller\ImgController();
        ...
        ]))->withContext('App\\Controller\\ImgController', $container));
